...
var HighchartsAdapter = (function () {
    var UNDEFINED, doc = document, emptyArray = [], timers = [], timerId, Fx;
    ...
    function augment(obj) {
        ...
        if (!obj.HCExtended) {
            Highcharts.extend(obj, {HCExtended:true, HCEvents:{}, bind:function (name, fn) {
    ...
    return {init:function (pathAnim) {
        ...
        Fx.prototype = {update:function () {
            ...
            var t = +new Date(), ret, done, options = this.options, i;
        ...
        this.animate = function (el, prop, opt) {
            var start, unit = "", end, fx, args, name;
            el.stopAnimation = false;
            if (typeof opt !== "object" || opt === null) {
                args = arguments;
                opt = {duration:args[2], easing:args[3], complete:args[4]};
            }
