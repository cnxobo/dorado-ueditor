...
function RGBColor(m) {
    ...
    }}, {re:/^(\w{2})(\w{2})(\w{2})$/, example:["#00ff00", "336699"], process:function (b) {
...
(function () {
    function m() {
        var a = {FRAMERATE:30, MAX_VIRTUAL_PIXELS:30000};
        a.init = function (c) {
            a.Definitions = {};
            a.Styles = {};
            a.Animations = [];
        ...
        a.Font = new function () {
            ...
            this.CreateFont = function (d, b, c, e, f, g) {
                ...
                return {fontFamily:f || g.fontFamily, fontSize:e || g.fontSize, fontStyle:d || g.fontStyle, fontWeight:c || g.fontWeight, fontVariant:b || g.fontVariant, toString:function () {
            ...
            this.Parse = function (d) {
                for (var b = {}, d = a.trim(a.compressSpaces(d || "")).split(" "), k = !1, e = !1, f = !1, g = !1, j = "", h = 0; h < d.length; h++) {
                    if (!e && c.Styles.indexOf(d[h]) != -1) {
                        ...
                        if (!g && c.Variants.indexOf(d[h]) != -1) {
                            if (d[h] != "inherit") {
                                b.fontVariant = d[h];
                            }
                            e = g = !0;
                        } else {
                            if (!f && c.Weights.indexOf(d[h]) != -1) {
                                if (d[h] != "inherit") {
                                    b.fontWeight = d[h];
                                }
                                e = g = f = !0;
        ...
        a.BoundingBox = function (a, d, b, k) {
            ...
            this.addBezierCurve = function (b, a, d, c, k, l, o, n) {
                ...
                for (i = 0; i <= 1; i++) {
                    ...
                    }, a = 6 * q[i] - 12 * p[i] + 6 * t[i], d = -3 * q[i] + 9 * p[i] - 9 * t[i] + 3 * m[i], c = 3 * p[i] - 3 * q[i], d == 0 ? a != 0 && (a = -c / a, 0 < a && a < 1 && (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a)))) : (c = Math.pow(a, 2) - 4 * c * d, c < 0 || (k = (-a + Math.sqrt(c)) / (2 * d), 0 < k && k < 1 && (i == 0 && this.addX(b(k)), i == 1 && this.addY(b(k))), a = (-a - Math.sqrt(c)) / (2 * d), 0 < a && a < 1 && (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a)))));
                }
            };
            ...
            if (c != null && c.nodeType == 1) {
                ...
                if (this.attribute("style").hasValue()) {
                    ...
                    for (d = 0; d < b.length; d++) {
                        a.trim(b[d]) != "" && (c = b[d].split(":"), k = a.trim(c[0]), c = a.trim(c[1]), this.styles[k] = new a.Property(k, c));
                    }
                }
            ...
            this.setContext = function (d) {
                if (this.style("fill").Definition.isUrl()) {
                    ...
                    if (this.style("fill").hasValue()) {
                        b = this.style("fill"), this.style("fill-opacity").hasValue() && (b = b.Color.addOpacity(this.style("fill-opacity").value)), d.fillStyle = b.value == "none" ? "rgba(0,0,0,0)" : b.value;
                    }
                }
                ...
                if (this.style("stroke-linecap").hasValue()) {
                    d.lineCap = this.style("stroke-linecap").value;
                }
        ...
        a.Element.svg = function (c) {
            ...
            this.setContext = function (d) {
                ...
                if (typeof this.root == "undefined" && this.attribute("width").hasValue() && this.attribute("height").hasValue()) {
                    var b = this.attribute("width").Length.toPixels("x"), c = this.attribute("height").Length.toPixels("y"), e = 0, f = 0;
        ...
        a.Element.rect = function (c) {
            ...
            this.base(c);
            this.path = function (d) {
                var b = this.attribute("x").Length.toPixels("x"), c = this.attribute("y").Length.toPixels("y"), e = this.attribute("width").Length.toPixels("x"), f = this.attribute("height").Length.toPixels("y"), g = this.attribute("rx").Length.toPixels("x"), j = this.attribute("ry").Length.toPixels("y");
        ...
        a.Element.polyline = function (c) {
            ...
            this.path = function (d) {
                ...
                for (var c = 1; c < this.points.length; c++) {
                    b.addPoint(this.points[c].x, this.points[c].y), d != null && d.lineTo(this.points[c].x, this.points[c].y);
                }
                return b;
            };
            this.getMarkers = function () {
            ...
            this.path = function (d) {
                ...
                for (d != null && d.beginPath(); !b.isEnd(); ) {
                    switch (b.nextCommand(), b.command.toUpperCase()) {
                      ...
                      case "C":
                        for (; !b.isCommandOrEnd(); ) {
                            var g = b.current, f = b.getPoint(), j = b.getAsControlPoint(), e = b.getAsCurrentPoint();
                            b.addMarker(e, j, f);
                      ...
                      case "A":
                        for (; !b.isCommandOrEnd(); ) {
                            var g = b.current, h = b.getScalar(), l = b.getScalar(), f = b.getScalar() * (Math.PI / 180), o = b.getScalar(), j = b.getScalar(), e = b.getAsCurrentPoint(), n = new a.Point(Math.cos(f) * (g.x - e.x) / 2 + Math.sin(f) * (g.y - e.y) / 2, -Math.sin(f) * (g.x - e.x) / 2 + Math.cos(f) * (g.y - e.y) / 2), q = Math.pow(n.x, 2) / Math.pow(h, 2) + Math.pow(n.y, 2) / Math.pow(l, 2);
                            ...
                            isNaN(o) && (o = 0);
                            var p = new a.Point(o * h * n.y / l, o * -l * n.x / h), g = new a.Point((g.x + e.x) / 2 + Math.cos(f) * p.x - Math.sin(f) * p.y, (g.y + e.y) / 2 + Math.sin(f) * p.x + Math.cos(f) * p.y), m = function (b, a) {
        ...
        a.Element.radialGradient = function (c) {
            ...
            this.base(c);
            this.getGradient = function (a, b) {
                var c = b.getBoundingBox(), e = this.gradientUnits == "objectBoundingBox" ? c.x() + c.width() * this.attribute("cx").numValue() : this.attribute("cx").Length.toPixels("x"), f = this.gradientUnits == "objectBoundingBox" ? c.y() + c.height() * this.attribute("cy").numValue() : this.attribute("cy").Length.toPixels("y"), g = e, j = f;
        ...
        a.Element.AnimateBase = function (c) {
            ...
            this.update = function (a) {
                ...
                if (this.begin < this.duration) {
                    a = this.calcValue(), this.attribute("type").hasValue() && (a = this.attribute("type").value + "(" + a + ")"), this.getProperty().value = a, a = !0;
                }
                return a;
            };
        ...
        a.Element.TextElementBase = function (c) {
            ...
            this.getGlyph = function (a, b, c) {
                ...
                if (a.isArabic) {
                    var g = "isolated";
                    if ((c == 0 || b[c - 1] == " ") && c < b.length - 2 && b[c + 1] != " ") {
                        g = "terminal";
                    }
            ...
            this.renderChildren = function (c) {
                ...
                if (b != null) {
                    var k = this.parent.style("font-size").numValueOrDefault(a.Font.Parse(a.ctx.font).fontSize), e = this.parent.style("font-style").valueOrDefault(a.Font.Parse(a.ctx.font).fontStyle), f = this.getText();
            ...
            this.measureText = function (c) {
                var b = this.parent.style("font-family").Definition.getDefinition();
                if (b != null) {
                    var c = this.parent.style("font-size").numValueOrDefault(a.Font.Parse(a.ctx.font).fontSize), k = 0, e = this.getText();
        ...
        a.Element.symbol = function (c) {
            ...
            this.setContext = function (c) {
                ...
                if (this.attribute("viewBox").hasValue()) {
                    var b = a.ToNumberArray(this.attribute("viewBox").value), k = b[0], e = b[1];
                    width = b[2];
                    height = b[3];
        ...
        a.Element.filter = function (c) {
            ...
            this.apply = function (a, b) {
                ...
                var g = this.attribute("width").Length.toPixels("x"), j = this.attribute("height").Length.toPixels("y");
                if (g == 0 || j == 0) {
            ...
            var k = a.CreateElement(d.documentElement), e = k.root = !0, f = function () {
                ...
                if (a.opts.ignoreDimensions != !0) {
                    ...
                    if (k.style("height").hasValue()) {
                        c.canvas.height = k.style("height").Length.toPixels("y"), c.canvas.style.height = c.canvas.height + "px";
                    }
                }
            ...
            a.intervalID = setInterval(function () {
                ...
                if (a.opts.ignoreAnimation != !0) {
                    for (var c = 0; c < a.Animations.length; c++) {
                        b |= a.Animations[c].update(1000 / a.FRAMERATE);
                    }
                }
