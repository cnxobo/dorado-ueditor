...
(function () {
    ...
    function Aa(a, b, c, d) {
        var e = M.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = N(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(C(a = N(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function Eb(a, b, c, d) {
        ...
        if (u(b)) {
            ...
            b = 1;
            h = i[ab]();
            for (var d = i.getTime(), l = i[$a](), m = i[Sa](), p = g ? 0 : (86400000 + i.getTimezoneOffset() * 60000) % 86400000; d < c; ) {
    ...
    D = function () {
        ...
        return d;
    }(Db, 1, pb, 1000, Ya, 60000, Qa, 3600000, ua, 86400000, Za, 604800000, Ra, 2678400000, Da, 31556952000);
    ...
    var ra = function (a) {
        ...
        (function (a) {
            a && a.stops ? d = Na(a.stops, function (a) {
                return ra(a[1]);
            }) : (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [C(c[1]), C(c[2]), C(c[3]), parseFloat(c[4], 10)] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) ? b = [C(c[1], 16), C(c[2], 16), C(c[3], 16), 1] : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) && (b = [C(c[1]), C(c[2]), C(c[3]), 1]);
        })(a);
        ...
        n(e, function (e, f) {
            ...
            n(m, function (e) {
                if (e !== "" || m.length === 1) {
                    ...
                    if (e !== " " && (n.appendChild(y.createTextNode(e)), o ? p.dx = 0 : p.x = i, v(n, p), !o && f && (!Z && d && K(n, {display:"block"}), v(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, gb && n.offsetHeight)), b.appendChild(n), o++, k)) {
    ...
    if (!Z && !$) {
        ...
        var ma = {Element:F, isIE8:oa.indexOf("MSIE 8.0") > -1, init:function (a, b, c) {
            ...
            if (i) {
                var k, l, m = a.linearGradient || a.radialGradient, p, q, o, A, L, s = "", a = a.stops, u, t = [], w = function () {
                ...
                if (c === "fill") {
                    if (i === "gradient") {
                        c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, s = "angle=\"" + (90 - R.atan((m - a) / (p - c)) * 180 / ya) + "\"", w();
                    } else {
                ...
                if (g.test(a) && b.tagName !== "IMG") {
                    f = ra(a), h = ["<", c, " opacity=\"", f.get("a"), "\"/>"], U(this.prepVML(h), null, null, b), j = f.get("rgb");
                } else {
    ...
    Ma.prototype = {addLabel:function () {
        var a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.series[0] && a.series[0].names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || c.chartWidth * 0.33), j = g === i[0], k = g === i[i.length - 1], l, f = e ? o(e[g], f && f[g], g) : g, e = this.label, m = i.info;
        ...
        if (i && !isNaN(H)) {
            i.xy = E = this.getLabelPosition(H, E, i, g, k, x, a, r), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? v = !1 : !C && g && k.overflow === "justify" && !this.handleOverflow(a, E) && (v = !1), r && a % r && (v = !1), v && !isNaN(E.y) ? (E.opacity = c, i[this.isNew ? "attr" : "animate"](E), this.isNew = !1) : i.attr("y", -9999);
        }
    }, destroy:function () {
        Ka(this, this.axis);
    }};
    vb.prototype = {render:function () {
        var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = u(j) && u(i), l = e.value, m = e.dashStyle, p = a.svgElem, q = [], n, A = e.color, L = e.zIndex, t = e.events, w = b.chart.renderer;
        ...
        if (p) {
            ...
            if (q && q.length && (a.svgElem = p = w.path(q).attr(d).add(), t)) {
    ...
    Mb.prototype = {destroy:function () {
        ...
        var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = N(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x:e ? f ? g : g - c : h, y:e ? i - h - b : f ? i - g - c : i - g, width:e ? c : b, height:e ? b : c};
        if (e = this.label) {
    ...
    db.prototype = {defaultOptions:{dateTimeLabelFormats:{millisecond:"%H:%M:%S.%L", second:"%H:%M:%S", minute:"%H:%M", hour:"%H:%M", day:"%e. %b", week:"%e. %b", month:"%b '%y", year:"%Y"}, endOnTick:!1, gridLineColor:"#C0C0C0", labels:G, lineColor:"#C0D0E0", lineWidth:1, minPadding:0.01, maxPadding:0.01, minorGridLineColor:"#E0E0E0", minorGridLineWidth:1, minorTickColor:"#A0A0A0", minorTickLength:2, minorTickPosition:"outside", startOfWeek:1, startOnTick:!1, tickColor:"#C0D0E0", tickLength:5, tickmarkPlacement:"between", tickPixelInterval:100, tickPosition:"outside", tickWidth:1, title:{align:"middle", style:{color:"#4d759e", fontWeight:"bold"}}, type:"linear"}, defaultYAxisOptions:{endOnTick:!0, gridLineWidth:1, tickPixelInterval:72, showLastLabel:!0, labels:{x:-8, y:3}, lineWidth:0, maxPadding:0.05, minPadding:0.05, startOnTick:!0, tickWidth:0, title:{rotation:270, text:"Values"}, stackLabels:{enabled:!1, formatter:function () {
    ...
    }, style:G.style}}, defaultLeftAxisOptions:{labels:{x:-8, y:null}, title:{rotation:270}}, defaultRightAxisOptions:{labels:{x:8, y:null}, title:{rotation:90}}, defaultBottomAxisOptions:{labels:{x:0, y:14}, title:{rotation:0}}, defaultTopAxisOptions:{labels:{x:0, y:-5}, title:{rotation:0}}, init:function (a, b) {
        var c = b.isX;
        ...
        if (h) {
            ...
            if (c) {
                ...
                if (d) {
                    ...
                    if (f && a >= 1000) {
                        for (; f-- && g === w; ) {
                            c = Math.pow(1000, f + 1), a >= c && e[f] !== null && (g = Aa(b / c, -1) + e[f]);
                        }
                    }
                }
            }
        }
        g === w && (g = b >= 1000 ? Aa(b, 0) : Aa(b, -1));
        return g;
        ...
        if (isNaN(a)) {
            ...
            if (this.horiz) {
                ...
                if (c = f, i = l - this.right, h < g || h > g + this.height) {
                    m = !0;
                }
            }
        }
        ...
        if (a >= 0.5) {
            ...
            if (a >= 0.08) {
                for (var f = P(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                    i = e.length;
                    for (h = 0; h < i && !l; h++) {
                        j = na(fa(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (l = !0), k = j;
                    }
                }
            } else {
                if (b = fa(b), c = fa(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ob(a, null, nb(a)), g = Na(this.getLinearTickPositions(a, b, c), na), !d) {
        ...
        var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval, m = d.minTickInterval, p = d.tickPixelInterval, q, ba = b.categories;
        ...
        if (e) {
            !a && I(b.min, o(b.dataMin, b.min)) <= 0 && ka(10, 1), b.min = ia(na(b.min)), b.max = ia(na(b.max));
        }
        ...
        b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && p === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = o(l, ba ? 1 : (b.max - b.min) * p / s(b.len, p)), !u(l) && b.len < p && !this.isRadial && (q = !0, b.tickInterval /= 4));
            ...
            if (a.horiz && !a.staggerLines && x && !q.rotation) {
                for (r = a.reversed ? [].concat(e).reverse() : e; v < x; ) {
                    ...
                    for (q = 0; q < r.length; q++) {
                        E = r[q], H = (H = f[E].label && f[E].label.getBBox()) ? H.width : 0, B = q % v, H && (E = a.translate(E), j[B] !== w && E < j[B] && (la = !0), j[B] = E + H);
                    }
                    if (la) {
                        v++;
                    } else {
        ...
        var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, p = d.alternateGridColor, q = a.tickmarkOffset, o = d.lineWidth, A, s = b.hasRendered && u(a.oldMin) && !isNaN(a.oldMin);
        A = a.hasData;
        ...
        if (o) {
            A = a.getLinePath(o), a.axisLine ? a.axisLine.animate({d:A}) : a.axisLine = c.path(A).attr({stroke:d.lineColor, "stroke-width":o, zIndex:7}).add(a.axisGroup), a.axisLine[t ? "show" : "hide"]();
        }
        if (h && t) {
        ...
        if (l) {
            ...
            for (d = l.length; d--; ) {
                if (m = a.series, e = m[d ? "yAxis" : "xAxis"], l[d] && e) {
                    if (h = d ? o(a.stackY, a.y) : a.x, e.isLog && (h = na(h)), d === 1 && m.modifyValue && (h = m.modifyValue(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d]) {
    ...
    xb.prototype = {init:function (a, b) {
        ...
        var h = this.chart, i = a ? "x" : "y", j = a ? "X" : "Y", k = "chart" + j, l = a ? "width" : "height", m = h["plot" + (a ? "Left" : "Top")], p, q, o = 1, n = h.inverted, s = h.bounds[a ? "h" : "v"], t = b.length === 1, u = b[0][k], r = c[0][k], w = !t && b[1][k], v = !t && c[1][k], x, c = function () {
        ...
        var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip && c.tooltip.options.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.zoomHor || b.pinchHor, j = b.zoomVert || b.pinchVert, k = i || j, l = b.selectionMarker, m = {}, p = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), q = {};
        ...
        this._events = c = [[b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [b, "onclick", "onContainerClick"], [b, "mouseleave", "onContainerMouseLeave"], [y, "mousemove", "onDocumentMouseMove"], [y, "mouseup", "onDocumentMouseUp"]];
    ...
    eb.prototype = {init:function (a, b) {
        ...
        var B;
        var b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, l = f ? o(e.itemDistance, 8) : 0, m = !e.rtl, p = e.width, q = e.itemMarginBottom || 0, n = b.itemMarginTop, A = b.initialItemX, t = a.legendItem, u = a.series || a, r = u.options, w = r.showCheckbox, v = e.useHTML;
        if (!t && (a.legendGroup = d.g("legend-item").attr({zIndex:1}).add(b.scrollGroup), u.drawLegendSymbol(b, a), a.legendItem = t = d.text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ? i : j)).attr({align:m ? "left" : "right", zIndex:2}).add(a.legendGroup), (v ? t : a.legendGroup).on("mouseover", function () {
            a.setState("hover");
        ...
        d > c && (d = c);
        if (d > 0) {
            b !== w && La(b, this.chart), this.nav.attr({translateX:i, translateY:e + 7 + this.titleHeight, visibility:"visible"}), this.up.attr({fill:d === 1 ? h : g}).css({cursor:d === 1 ? "default" : "pointer"}), f.attr({text:d + "/" + this.pageCount}), this.down.attr({x:18 + this.pager.getBBox().width, fill:d === c ? h : g}).css({cursor:d === c ? "default" : "pointer"}), e = -I(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({translateY:e}), f.attr({text:d + "/" + c}), this.currentPage = d, this.positionCheckboxes(e);
        }
    }};
    ...
    yb.prototype = {init:function (a, b) {
        ...
        a ? b && (this.renderTo.appendChild(c), Ta(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), K(b, {position:"absolute", top:"-9999px", display:"block"}), y.body.appendChild(b), c && b.appendChild(c));
        ...
        e.items && n(e.items, function (b) {
            var d = r(e.style, b.style), f = C(d.left) + a.plotLeft, g = C(d.top) + a.plotTop + 12;
            delete d.left;
            delete d.top;
        ...
        if (a.isReadyToRender()) {
            a.getContainer(), z(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function (b) {
                a.initSeries(b);
            }), a.linkSeries(), z(a, "beforeRender"), a.pointer = new xb(a, b), a.render(), a.renderer.draw(), c && c.apply(a, [a]), n(a.callbacks, function (b) {
                b.apply(a, [a]);
    ...
    Q.prototype = {isCartesian:!0, type:"line", pointClass:Pa, sorted:!0, requireSorting:!0, pointAttrToOptions:{stroke:"lineColor", "stroke-width":"lineWidth", fill:"fillColor", r:"radius"}, colorCounter:0, init:function (a, b) {
        ...
        if (i && m > i) {
            ...
            for (i = 0; i < m; i++) {
                if (a[i] !== w && (d = {series:this}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, l[i] = d.z, h && d.name)) {
                    h[d.x] = d.name;
                }
            }
        }
        ...
        if (!c.isRemoving) {
            c.isRemoving = !0, z(c, "remove", null, function () {
                c.destroy();
        ...
        for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || sa(i), k = a.threshold, a = 0; a < g; a++) {
            ...
            if (b && this.visible && n && n[m]) {
                n = n[m], p = n.points[this.index], q = p[0], p = p[1], q === 0 && (q = o(k, e.min)), e.isLog && q <= 0 && (q = null), l.percentage = b === "percent" && p, l.total = l.stackTotal = n.total, l.stackY = p, n.setOffset(this.pointXOffset || 0, this.barW || 0);
            }
        ...
        n(c, function (c, g) {
            ...
            if (k) {
                ...
                if (d && f.length) {
                    k = {stroke:c[1], "stroke-width":d, zIndex:1}, e ? k.dashstyle = e : k["stroke-linecap"] = k["stroke-linejoin"] = "round", a[j] = a.chart.renderer.path(f).attr(k).add(a.group).shadow(!g && b.shadow);
                }
            }
        });
    }, clipNeg:function () {
    ...
    G = ha(Q, {type:"area", getSegments:function () {
        ...
        if (this.options.stacking && !this.cropped) {
            ...
            n(c, function (a) {
                if (!k || g[a] && g[a].y !== null) {
                    g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? f[a].cum * 100 / f[a].total : 0 : f[a].cum, i = e.toPixels(l, !0), b.push({y:null, plotX:h, clientX:h, plotY:i, yBottom:i, onMouseOver:pa}));
                }
            });
            b.length && a.push(b);
        } else {
    ...
    F = ha(Q, {type:"column", pointAttrToOptions:{stroke:"borderColor", "stroke-width":"borderWidth", fill:"color", r:"borderRadius"}, cropShoulder:0, trackerGroups:["group", "dataLabelsGroup"], negStacks:!0, init:function () {
        ...
        var a = this.chart, b = this.options, c = b.borderWidth, d = this.yAxis, e = this.translatedThreshold = d.getThreshold(b.threshold), f = o(b.minPointLength, 5), b = this.getColumnMetrics(), g = b.width, h = this.barW = xa(s(g, 1 + 2 * c)), i = this.pointXOffset = b.offset, j = -(c % 2 ? 0.5 : 0), k = c % 2 ? 0.5 : 1;
    ...
    X = {type:"pie", isCartesian:!1, pointClass:ha(Pa, {init:function () {
        ...
        var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center, a = [o(b[0], "50%"), o(b[1], "50%"), a.size || "100%", a.innerSize || 0], g = I(e, f), h;
        ...
        this.generatePoints();
        var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = ya / 180 * (i - 90), i = (this.endAngleRad = ya / 180 * ((c.endAngle || i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = k.length, o;
        if (!a) {
        ...
        for (m = 0; m < n; m++) {
            ...
            g = j + b * i;
            o.shapeType = "arc";
            o.shapeArgs = {x:a[0], y:a[1], r:a[2] / 2, innerR:a[3] / 2, start:t(f * 1000) / 1000, end:t(g * 1000) / 1000};
            h = (g + f) / 2;
            h > 0.75 * i && (h -= 2 * ya);
        ...
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector, !0), l = e.distance, m = a.center, p = m[2] / 2, q = m[1], u = l > 0, r, w, v, x, C = [[], []], y, z, E, H, B, D = [0, 0, 0, 0], I = function (a, b) {
            return b.y - a.y;
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (H = 2; H--; ) {
                ...
                for (B = 0; B < J; B++) {
                    ...
                    c = v[1];
                    if (l > 0) {
                        if (w = K.pop(), F = w.i, z = w.y, c > z && b[F + 1] !== null || c < z && b[F - 1] !== null) {
                            z = c;
                        }
                    } else {
                        z = c;
    ...
    }, alignDataLabel:pa, drawTracker:F.prototype.drawTracker, drawLegendSymbol:G.prototype.drawLegendSymbol, getSymbol:pa};
    X = ha(Q, X);
    W.pie = X;
    r(Highcharts, {Axis:db, Chart:yb, Color:ra, Legend:eb, Pointer:xb, Point:Pa, Tick:Ma, Tooltip:wb, Renderer:Va, Series:Q, SVGElement:wa, SVGRenderer:Ha, arrayMin:Ja, arrayMax:va, charts:Ga, dateFormat:Xa, format:Ca, pathAnim:Ab, getOptions:function () {
        ...
        Lb();
        return M;
    }, addEvent:J, removeEvent:aa, createElement:U, discardElement:Ta, css:K, each:n, extend:r, map:Na, merge:x, pick:o, splat:ja, extendClass:ha, pInt:C, wrap:mb, svg:Z, canvas:$, vml:!Z && !$, product:"Highcharts", version:"3.0.6"});
})();
