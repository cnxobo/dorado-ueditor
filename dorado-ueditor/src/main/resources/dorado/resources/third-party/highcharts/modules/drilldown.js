...
(function (e) {
    ...
    var m = function () {
    }, j = e.getOptions(), g = e.each, n = e.extend, o = e.wrap, h = e.Chart, i = e.seriesTypes, k = i.pie, l = i.column, r = HighchartsAdapter.fireEvent;
    n(j.lang, {drillUpText:"\u25c1 Back to {series.name}"});
    j.drilldown = {activeAxisLabelStyle:{cursor:"pointer", color:"#039", fontWeight:"bold", textDecoration:"underline"}, activeDataLabelStyle:{cursor:"pointer", color:"#039", fontWeight:"bold", textDecoration:"underline"}, animation:{duration:500}, drillUpButton:{position:{align:"right", x:-10, y:10}}};
    ...
    h.prototype.addSeriesAsDrilldown = function (b, a) {
        ...
        this.drilldownLevels.push({seriesOptions:c.userOptions, shapeArgs:b.shapeArgs, bBox:b.graphic.getBBox(), color:e, newSeries:a, pointOptions:c.options.data[g], pointIndex:g, oldExtremes:{xMin:d && d.userMin, xMax:d && d.userMax, yMin:f && f.userMin, yMax:f && f.userMax}});
    ...
    h.prototype.drillUp = function () {
        var b = this.drilldownLevels.pop(), a = this.series[0], c = b.oldExtremes, d = this.addSeries(b.seriesOptions, !1);
    ...
    l.prototype.animateDrilldown = function (b) {
        var a = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1].shapeArgs, c = this.chart.options.drilldown.animation;
    ...
    o(e.Series.prototype, "drawDataLabels", function (b) {
        ...
        g(this.points, function (b) {
            if (b.drilldown && b.dataLabel) {
                b.dataLabel.attr({"class":"highcharts-drilldown-data-label"}).css(a).on("click", function () {
                    b.doDrilldown();
                });
            }
        });
