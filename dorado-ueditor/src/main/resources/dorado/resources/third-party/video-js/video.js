...
(function () {
    ...
    u.j = function (a, c) {
        ...
        if (e && !c.Cb() && c.bubbles !== l) {
            ...
            if (!e && !c.Ab() && (d = u.getData(c.target), c.target[c.type])) {
                d.disabled = f;
    ...
    u.k.ic = function (a, c) {
        ...
        a = u.k.copy(a);
        for (d in c) {
            w.call(c, d) && (e = a[d], g = c[d], a[d] = u.k.qc(e) && u.k.qc(g) ? u.k.ic(e, g) : c[d]);
        }
        return a;
    };
    u.k.copy = function (a) {
    ...
    function E(a, c, d, e) {
        if (d !== b) {
            return a.a.style[c] = -1 !== ("" + d).indexOf("%") || -1 !== ("" + d).indexOf("px") ? d : "auto" === d ? "" : d + "px", e || a.j("resize"), a;
        }
        if (!a.a) {
            return 0;
        }
    ...
    function F(a, c) {
        ...
        d = a.handle;
        if (a.g.Cd) {
            return j = e.top, e = c.changedTouches ? c.changedTouches[0].pageY : c.pageY, d && (d = d.w().offsetHeight, j += d / 2, g -= d), Math.max(0, Math.min(1, (j - e + g) / g));
        }
        g = e.left;
    ...
    function da(a) {
        ...
        if (a.hasChildNodes()) {
            ...
            for (j = a.length; g < j; g++) {
                d = a[g], e = d.nodeName.toLowerCase(), "source" === e ? c.sources.push(u.xb(d)) : "track" === e && c.tracks.push(u.xb(d));
            }
        }
        return c;
    }
    ...
    t.volume = function (a) {
        if (a !== b) {
            return a = Math.max(0, Math.min(1, parseFloat(a))), this.v.volume = a, L(this, "setVolume", a), u.td(a), this;
        }
    ...
    t.ob = function () {
        ...
        if (a) {
            ...
            this.h.Ta() ? L(this, "exitFullScreen") : (M(this), this.j("fullscreenchange"));
        }
        return this;
    };
    t.lc = function (a) {
    ...
    t.src = function (a) {
        ...
        a instanceof Object ? window.videojs[this.ia].canPlaySource(a) ? this.src(a.src) : this.src([a]) : (this.v.src = a, this.aa ? (L(this, "src", a), "auto" == this.g.preload && this.load(), this.g.autoplay && this.play()) : this.L(function () {
            this.src(a);
        }));
    }
    return this;
...
u.Yb = u.q.extend({i:function (a, c) {
    u.q.call(this, a, c);
...
u.Ya = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
...
u.Za = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
    a.d("timeupdate", u.bind(this, this.Ca));
}});
...
u.Ga = u.q.extend({i:function (a, c) {
    u.q.call(this, a, c);
}});
...
u.eb = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
}});
...
u.Zb = u.O.extend({i:function (a, c) {
    u.O.call(this, a, c);
...
u.ab = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
...
u.Xb = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
}});
...
u.ib = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
...
u.hb = u.O.extend({i:function (a, c) {
    u.O.call(this, a, c);
...
u.dc = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
}});
...
u.da = u.q.extend({i:function (a, c) {
    u.q.call(this, a, c);
...
u.oa = u.R.extend({i:function (a, c) {
    u.R.call(this, a, c);
    a.d("volumechange", u.bind(this, this.update));
...
u.cb = u.q.extend({i:function (a, c) {
    u.q.call(this, a, c);
...
u.Wb = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
...
t.e = function () {
    ...
    if (!c || this.m.movingMediaElementInDOM === l) {
        c ? (d = c.cloneNode(l), u.l.jc(c), c = d, a.M = h) : c = u.e("video", {id:a.id() + "_html5_api", className:"vjs-tech"}), c.player = a, u.zb(c, a.w());
    }
...
function W(a, c, d) {
    for (var e = a.Aa, g = 0, j = e.length, k, q; g < j; g++) {
        k = e[g], k.id() === c ? (k.show(), q = k) : d && (k.J() == d && 0 < k.mode()) && k.disable();
    }
    (c = q ? q.J() : d ? d : l) && a.j(c + "trackchange");
}
u.X = u.c.extend({i:function (a, c) {
    u.c.call(this, a, c);
            ...
            for (; ; ) {
                ...
                if (n.va <= a) {
                    ...
                    if (a < n.startTime) {
                        ...
                        g ? (j.splice(0, 0, n), q === b && (q = r), k = r) : (j.push(n), k === b && (k = r), q = r), d = Math.min(d, n.va), e = Math.max(e, n.startTime), n.Ia = f;
                    }
                }
                if (g) {
                    if (0 === r) {
...
u.bb = u.Y.extend({i:function (a, c) {
    c.track = {J:function () {
        return c.kind;
    }, K:a, label:function () {
        return c.kind + " off";
...
u.S.prototype.ta = function () {
    ...
    for (var d = 0; d < V(this.b).length; d++) {
        c = V(this.b)[d], c.J() === this.A && a.push(new u.Y(this.b, {track:c}));
    }
    return a;
};
...
u.Ha = u.S.extend({i:function (a, c, d) {
    u.S.call(this, a, c, d);
...
u.Ea = u.S.extend({i:function (a, c, d) {
    u.S.call(this, a, c, d);
...
t.Ka = function () {
    ...
    if (g) {
        ...
        for (var k, c = 0, d = e.length; c < d; c++) {
            k = e[c], k = new u.Xa(this.b, {track:g, cue:k}), j.push(k), a.Z(k);
        }
    }
    0 < this.I.length && this.show();
    return a;
};
u.Xa = u.N.extend({i:function (a, c) {
