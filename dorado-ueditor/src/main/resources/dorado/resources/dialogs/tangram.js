...
baidu.swf.createHTML = function (options) {
    ...
    str.push(">");
    var params = {"wmode":1, "scale":1, "quality":1, "play":1, "loop":1, "menu":1, "salign":1, "bgcolor":1, "base":1, "allowscriptaccess":1, "allownetworking":1, "allowfullscreen":1, "seamlesstabbing":1, "devicefont":1, "swliveconnect":1, "flashvars":1, "movie":1};
    for (k in options) {
        item = options[k];
        k = k.toLowerCase();
...
baidu.flash._Base = (function () {
    ...
    return function (options, callBack) {
        var me = this, autoRender = (typeof options.autoRender !== "undefined" ? options.autoRender : true), createOptions = options.createOptions || {}, target = null, isReady = false, callQueue = [], timeHandle = null, callBack = callBack || [];
        me.render = function () {
        ...
        me.call = function (fnName, params, callBack) {
            ...
            if (isReady) {
                ...
                callQueue.push({fnName:fnName, params:params, callBack:callBack});
...
baidu.flash.imageUploader = baidu.flash.imageUploader || function (options) {
    var me = this, options = options || {}, _flash = new baidu.flash._Base(options, ["selectFileCallback", "exceedFileCallback", "deleteFileCallback", "startUploadCallback", "uploadCompleteCallback", "uploadErrorCallback", "allCompleteCallback", "changeFlashHeight"]);
    me.upload = function () {
        _flash.call("upload");
    };
    me.pause = function () {
...
baidu.flash.fileUploader = baidu.flash.fileUploader || function (options) {
    ...
    options.createOptions = baidu.extend({wmod:"transparent"}, options.createOptions || {});
    ...
    me.upload = function (url, fieldName, postData, index) {
        if (typeof url !== "string" || typeof fieldName !== "string") {
            return null;
        }
...
baidu.sio.log = function (url) {
    var img = new Image(), key = "tangram_sio_log_" + Math.floor(Math.random() * 2147483648).toString(36);
    window[key] = img;
