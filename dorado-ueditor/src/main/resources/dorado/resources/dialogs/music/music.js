...
(function () {
    ...
    Music.prototype = {total:70, pageSize:10, dataUrl:"http://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.search.common", playerUrl:"http://box.baidu.com/widget/flash/bdspacesong.swf", init:function () {
        var me = this;
        ...
        utils.loadFile(document, {src:me.dataUrl + "&query=" + param + "&page_size=" + me.total + "&callback=music.callback&.r=" + Math.random(), tag:"script", type:"text/javascript", defer:"defer"});
        ...
        var me = this, newData = [], d = me.pageSize, itembox;
        ...
        editor.execCommand("music", {url:me._getUrl(false), width:400, height:95});
    }};
})();
