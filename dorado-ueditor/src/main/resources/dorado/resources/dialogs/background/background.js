...
(function () {
    ...
    function initColorPicker() {
        ...
        var popup = new UE.ui.Popup({content:new UE.ui.ColorPicker({noColorText:me.getLang("clearColor"), editor:me, onpickcolor:function (t, color) {
    ...
    function getImageData(callback) {
        ajax.request(editor.options.imageManagerUrl, {timeout:100000, action:"get", onsuccess:function (r) {
        ...
        if (utils.isArray(data) && data) {
            utils.each(data, function (value, key) {
                ...
                domUtils.on(img, "click", function (e) {
                    var target = e.target || e.srcElement, nodes = imagePanel.childNodes;
    ...
    function updateBackground() {
        if ($G("coloredRadio").checked) {
            ...
            if (align == "self") {
                ...
                if (align == "repeat-x" || align == "repeat-y" || align == "repeat") {
