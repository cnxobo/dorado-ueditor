...
var wordImage = {};
var g = baidu.g, flashObj, flashContainer;
        ...
        for (var i = 0, img; img = images[i++]; ) {
            ...
            for (var j = 0, url; url = imageUrls[j++]; ) {
                if (src.indexOf(url.original.replace(" ", "")) != -1) {
                    ...
                    img.setAttribute("_src", editor.options.wordImagePath + url.url);
...
function showLocalPath(id) {
    ...
    var path = images[0];
    var leftSlashIndex = path.lastIndexOf("/") || 0, rightSlashIndex = path.lastIndexOf("\\") || 0, separater = leftSlashIndex > rightSlashIndex ? "/" : "\\";
...
function createCopyButton(id, dataFrom) {
    baidu.swf.create({id:"copyFlash", url:"fClipboard_ueditor.swf", width:"58", height:"25", errorMessage:"", bgColor:"#CBCBCB", wmode:"transparent", ver:"10.0.0", vars:{tid:dataFrom}}, id);
